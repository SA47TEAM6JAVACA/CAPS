...
<form:form action="${pageContext.request.contextPath}/Admin/newCoures.html" mehtod="POST" modelAttribute="course">
  ID:<form:input path="cid" size="11" readonly="true"/><br/>
